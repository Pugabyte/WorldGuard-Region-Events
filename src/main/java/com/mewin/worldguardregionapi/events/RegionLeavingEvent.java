 ...
 * @author mewin
 */
public class RegionLeavingEvent extends RegionEvent implements Cancellable {
	 ...
	 */
	public RegionLeavingEvent(ProtectedRegion region, Player player, MovementType movement, Event parent) {
